...
### **竹子机**  
`/player bamboo spawn at -229 62 -578 facing 0 0 in minecraft:the_end`
...
3.**确认树种与假人手中树苗一致后，先开启机器开关后再键入此条指令开启假人**  
 `/player bot_puft use continuous`  
4.**关机时，先键入以下指令再关闭机器开关**  
...
3.**确认菌种与假人手中蘑菇一致后，先开启机器开关后再键入此条指令开启假人**  
